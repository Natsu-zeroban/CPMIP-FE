layui.use('table', function(){
    ...
    table.render({
        ...
        //会默认自动传送page和limit参数
        ,url:'http://www.cpmip.cn/aqsg/get_time_list.do'
        ,method:'post'
        //其他参数
        // ,where:{}
        ...
        ,cols: [[
            ...
            ,{field:'construction', align:'center', title: '施工单位名称'}
            ,{field:'build', align:'center', title: '建设单位名称'}
            ,{field:'position', align:'center', title: '工程地点', minWidth: 100}
            ,{field:'reportTime', align:'center', title: '事故上报时间', minWidth: 100}
        ]]
        //开启分页
        ,page: true
    });
                        ...
                        for (var k = 0; k < checkStatus.data.length; k++) {
                            ...
                            for (var i = 0; i < cbList.length; i++) {
                                ...
                                if (_id === _delId) {
                                    ...
                                    $.ajax({
                                        url:'http://www.cpmip.cn/aqsg/delete.do'
                                        ,method:"post"
                                        ,data:{id:_id}
                                        ,xhrFields:{
...
function tableSet() {
    layer.open({
        ...
        title: '填写安全事故报告'
        ,area: ['800px', '600px']     //area: ['390px', '330px'],   //宽高
        ,shade: 0.8         //遮罩透明度

        ,content: 'safetyAccidentReport_add.html'
        ...
        //             happenTime: '2016-01-01 01:01:01',
        //             reportTime: '2016-01-01 01:01:01',
    ...
    //     ,yes: function () {
    //         //传表单数据过去
    //     //     $.post("http://www.cpmip.cn/agsq/add.do", {
    //     //             construname:$.trim($('#safetyAR_construname').val()),
    //     //             construction:$.trim($('#safetyAR_construction').val()),
    //     //             build:$.trim($('#safetyAR_build').val()),
    //     //             happenTime:$.trim($('#safetyAR_happenTime').val()),
    //     //             reportTime:$.trim($('#safetyAR_reportTime').val()),
    //     //             reason:$.trim($('#safetyAR_reason').val()),
    //     //             action:$.trim($('#safetyAR_action').val()),
    //     //             positioin:$.trim($('#safetyAR_position').val()),
    //     //         },
    //     //         console.log($.trim($('#safetyAR_construname').val()))
    //     //     )
    //     // }
    // });
}
