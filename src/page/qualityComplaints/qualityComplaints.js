layui.use('table', function(){
    ...
    table.render({
        ...
        //会默认自动传送page和limit参数
        ,url:'http://www.cpmip.cn/comp/get_list.do'
        ,method:'post'
        //其他参数
        // ,where:{}
        ...
        ,cols: [[
            ...
            ,{field:'complaintsTime', align:'center', title: '投诉时间'}
            ,{field:'deal', align:'center', title: '施工方是否解决'}
            ,{field:'examine', align:'center', title: '质量监管部门是否检查'}
            ,{field:'down', align:'center', title: '该投诉是否完成'}
        ]]
        //开启分页
        ,page: true
    });
    ...
    table.on('toolbar(test)', function(obj){
        ...
        switch(obj.event) {
            ...
            //                         $.ajax({
            //                             url:'http://www.cpmip.cn/comp/delete.do'
            //                             ,method:"post"
            //                             ,data:{id:_id}
            //                             ,xhrFields:{
