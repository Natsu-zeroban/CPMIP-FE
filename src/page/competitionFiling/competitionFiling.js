layui.use('table', function(){
    ...
    table.render({
        ...
        //会默认自动传送page和limit参数
        ,url:'http://www.cpmip.cn/final/get_list.do'
        ,method:'post'
        //其他参数
        // ,where:{}
        ...
        ,cols: [[
            ...
            ,{field:'finalTime', align:'center', title: '竣工时间'}
        ]]
        //开启分页
        ,page: true
    });
                        ...
                        for (var k = 0; k < checkStatus.data.length; k++) {
                            ...
                            for (var i = 0; i < cbList.length; i++) {
                                ...
                                if (_id === _delId) {
                                    ...
                                    $.ajax({
                                        url:'http://www.cpmip.cn/final/delete.do'
                                        ,method:"post"
                                        ,data:{id:_id}
                                        ,xhrFields:{
...
function tableSet() {
    layer.open({
        ...
        title: '填写竣工备案信息表', //页面标题
        shadeClose: true, //点击遮罩区域是否关闭页面
        shade: 0.8,  //遮罩透明度
        area: ['900px', '700px'],  //弹出层页面比例
        content:'competitionFiling_add.html'
